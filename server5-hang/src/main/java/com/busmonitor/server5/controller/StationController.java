...
public class StationController {
    ...
    public String dashboard() {
        return buildDashboard("server5-hang", "Hang", server1Url);
    }
    ...
    static String buildDashboard(String serverId, String serverName, String server1Url) {
        return "<!DOCTYPE html><html lang='vi'><head><meta charset='UTF-8'>"
            ...
            + "<text x='218' y='100' text-anchor='middle' font-size='9' font-weight='700' fill='#c8dff0' font-family='Exo 2'>Hang</text></g>"
            ...
            + "const ST=[{id:'server1-ngan',name:'Ngan',nid:'n1',cx:130,cy:40},{id:'server5-hang',name:'Hang',nid:'n2',cx:218,cy:93},{id:'server3-my',name:'My',nid:'n3',cx:187,cy:197},{id:'server4-suong',name:'Suong',nid:'n4',cx:73,cy:197},{id:'server5-hang',name:'Hang',nid:'n5',cx:42,cy:93}];"
